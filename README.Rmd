...
dem <-   stars::read_stars("data/DEM_srtm/z12.tif")
...
viviendas_por_mz <- 
  ...
  dplyr::left_join(censo, by="ID_MANZ") 
...
La data a nivel de predio tiene alto nivel de detalle pero pesa bastante, se demora un rato en graficar.

```{r}
predios = sf::read_sf("data/predios.gpkg")

plot(predios, max.plot =1)
